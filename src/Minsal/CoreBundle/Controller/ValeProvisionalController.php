...
class ValeProvisionalController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('vales_show', array('id' => $valeProvisional->getId()));
        }
    ...
    public function editAction(Request $request, ValeProvisional $valeProvisional)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('vales_edit', array('id' => $valeProvisional->getId()));
        }
    ...
    public function deleteAction(Request $request, ValeProvisional $valeProvisional)
    {
        ...
        return $this->redirectToRoute('vales_index');
    }
    ...
    private function createDeleteForm(ValeProvisional $valeProvisional)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('vales_delete', array('id' => $valeProvisional->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
